...
public class WarResearchTreeResource extends SimpleJsonResourceReloadListener {
    public static final String FOLDER = "research_war";
    private static final Gson GSON = new Gson();
    private static volatile Map<String, ResearchDefinition> TREE = Map.of();

    public WarResearchTreeResource() {
        super(GSON, FOLDER);
    }
