...
public class CultureResearchTreeResource extends SimpleJsonResourceReloadListener {
    public static final String FOLDER = "research_culture";
    private static final Gson GSON = new Gson();
    private static volatile Map<String, ResearchDefinition> TREE = Map.of();

    public CultureResearchTreeResource() {
        super(GSON, FOLDER);
    }
