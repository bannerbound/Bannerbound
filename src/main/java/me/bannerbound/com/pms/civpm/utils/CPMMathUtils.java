...
public class CPMMathUtils {
    public static class CPM2DUtils {
        ...
        public static long blockToPacked(int x, int z) {
            return pack(Mth.floor(x / 48.0), Mth.floor(z / 48.0));
        }
        ...
        public static long offsetRegionPosBy(long region_pos, int x, int y) {
            int rx = CPM2DUtils.unpackX(region_pos);
            int ry = CPM2DUtils.unpackY(region_pos);
